...
print(sigma_A_expanded.shape, m_expanded.shape)
#print("x:\n", x)
...
y_outer_product_w = np.einsum("ij,ijkl->ijkl", weights, y_outer_product)
#print("weights:\n", weights)
#print("y_outer_product:\n", y_outer_product)
#print("y_outer_product_w:\n", y_outer_product_w)
...
# Updates of the thing
m = m + c_m * y_w_sum
#print(z_w_sum)
#print(np.square(np.linalg.norm(z_w_sum, axis=1))/2)
new_sigma = sigma * np.exp(c_sigma * (np.square(np.linalg.norm(z_w_sum, axis=1)) / 2 - 1))
