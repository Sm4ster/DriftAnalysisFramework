...
from DriftAnalysisFramework.Interpolation import closest_values_fast, closest_values
...
def test_closest_values():
    ...
    # Run both functions
    l_closest_values_orig, h_closest_values_orig, l_closest_indices_orig, h_closest_indices_orig = closest_values(needle_values, haystack_array)
    l_closest_values_opt, h_closest_values_opt, l_closest_indices_opt, h_closest_indices_opt = closest_values_fast(needle_values, haystack_array)
