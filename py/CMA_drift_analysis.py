...
potential_functions = [
    ...
    ['f(\\kappa) \\cdot filter1_{\\kappa}(|\\log(\\kappa/\\kappa^*)|)',
     "f(kappa) * k_filter_1(abs(log(kappa/stable_kappa(alpha,sigma))), alpha, kappa)"],
    ...
    ['f(\\kappa) \\cdot filter1_{\\kappa}(|\\log(\\kappa/\\kappa_t)|, \\alpha, \\kappa)',
     "f(kappa) * k_filter_1(abs(log(kappa/target_kappa(alpha,sigma))), alpha, kappa)"],
